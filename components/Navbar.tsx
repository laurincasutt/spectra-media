...
export default function Navbar() {
  ...
  return (
    <>
      {/* ── MOBILE header: full-width frosted glass bar ── */}
      <header
        className={`lg:hidden fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-5 h-16 transition-all duration-300 ${
          scrolled
            ? "bg-[#09090B]/60 backdrop-blur-2xl border-b border-white/8"
      ...
      >
        ...
        <Link href="/" className="flex items-center">
          <Image
            ...
            height={40}
            priority
            className="h-10 w-10 object-contain drop-shadow-[0_0_12px_rgba(0,102,255,0.4)]"
          />
        </Link>
        ...
        <div className="flex items-center gap-3">
          <a
            ...
            aria-label="WhatsApp"
            className="flex items-center justify-center w-9 h-9 rounded-xl bg-white/8"
          >
      ...
      <div className="hidden lg:flex fixed top-4 left-0 right-0 z-50 justify-center px-4">
        <div className="w-full max-w-5xl flex items-center gap-3">
          ...
          {/* Nav pill */}
          <header
            className={`flex-1 flex items-center justify-between px-5 h-14 rounded-2xl border transition-all duration-300 ${
              scrolled
