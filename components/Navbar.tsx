  ...
  return (
    <>
      ...
      <div className="fixed top-4 left-0 right-0 z-50 flex justify-center px-4">
        <header
          className={`w-full max-w-5xl flex items-center justify-between px-4 lg:px-5 h-14 rounded-2xl border transition-all duration-300 ${
            scrolled
